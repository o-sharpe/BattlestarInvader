...
namespace Screen
{
	public class Sprite
	{
		...
		public Rectangle BoundingBoxRec
		{
			get
			{
				return new Rectangle((int)worldLocation.X + BoundingXPadding, (int)worldLocation.Y + BoundingYPadding,
								  FrameWidth - (BoundingXPadding * 2), FrameWidth - (BoundingYPadding * 2));
			}
		}
		...
		public bool IsBoxColliding(Rectangle OtherBox)
		{
			...
			{
				return BoundingBoxRec.Intersects(OtherBox);
			}
			else
			{
				return false;
